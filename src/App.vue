...
<template>
  <div class="fixed w-full h-screen bg-black">
    ...
    >
      <div class="absolute top-0 w-[120px]">
        <img
          class="w-[35px] mt-10 mx-auto"
    ...
    <div v-if="showFullVideo">
      <div
        ...
        class="absolute z-50 p-2 m-4 bg-black cursor-pointer"
      >
      ...
      <video
        ...
        loop
        controls
        class="absolute z-0 w-screen h-full object-fit"
      />
    </div>
  </div>
</template>
